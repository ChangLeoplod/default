...
if($dopost == 'gethotelroom_show')
{
	...
	foreach($arr as $row)
	{
		...
		$tablebody.='<tr>
				...
				<td width="100" align="center" valign="middle"><a class="h_pro_yd btn_hotel_book" href="javascript:;" data-roomid="'.$row['id'].'" data-hotelid="'.$hotelid.'" data-hotelname="'.$hotelinfo['hotelname'].'['.$row['roomname'].']">预&nbsp;定</a></td>
                </tr>';
