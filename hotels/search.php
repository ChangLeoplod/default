...
if(!empty($dest_id))
{
    $sql="select a.*,b.isjian ,b.isding,b.istejia from #@__hotel a left join #@__kindorderlist b on (a.id=b.aid and b.typeid={$typeid} and a.webid=b.webid and b.classid='$dest_id') {$where} order by b.isding desc,b.displayorder asc,a.modtime desc,a.addtime desc  ";
}
else
{
    $sql="select a.*,b.isjian ,b.isding,b.istejia from #@__hotel a left join #@__allorderlist b on (a.id=b.aid and b.typeid={$typeid} and a.webid=b.webid ) {$where} order by b.isding desc,b.displayorder asc,a.modtime desc,a.addtime desc  ";
}
