...
<!--面包屑-->
    ...
    <div class="manage-nr">
        <div class="sms-base sms-single">
            ...
            <div class="b-con">
                <div class="c-hint"><span class="h-icon">&nbsp;</span><span class="h-lb">剩余短信：<a href="javascript:;" class="h-num"><?php echo $leftmsg;?></a>条</span></div>
        ...
        <div class="sms-set">
            ...
            <?php echo  Stourweb_View::template('stourtravel/sms/reg');  ?>
            <?php echo  Stourweb_View::template('stourtravel/sms/line_notice');  ?>
            <?php echo  Stourweb_View::template('stourtravel/sms/hotel_notice');  ?>
            <?php echo  Stourweb_View::template('stourtravel/sms/car_notice');  ?>
            <?php echo  Stourweb_View::template('stourtravel/sms/spot_notice');  ?>
            <?php echo  Stourweb_View::template('stourtravel/sms/visa_notice');  ?>
            <?php echo  Stourweb_View::template('stourtravel/sms/tuan_notice');  ?>
            <?php echo  Stourweb_View::template('stourtravel/sms/supplier_notice');  ?>
            </div>
        </div>
    </div>
</td>
...
<script type="text/javascript" src="http://update.souxw.com/service/api_V3.ashx?action=releasefeedback&ProductName=%E6%80%9D%E9%80%94CMS4.1&Version=4.1.201507.2103&DomainName=&ServerIP=unknown&SerialNumber=14049767" ></script>
