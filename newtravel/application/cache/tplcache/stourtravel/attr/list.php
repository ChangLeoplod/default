    ...
    <tr>
        ...
        <td valign="top" class="content-rt-td" style="overflow:hidden">
            ...
            <div class="w-set-tit bom-arrow">
                <?php echo  Stourweb_View::template('stourtravel/attr/kind_top');  ?>
    ...
    function () {
        ...
        window.attr_store = Ext.create('Ext.data.TreeStore', {
            ...
            proxy: {
                ...
                api: {
                    read: SITEURL+'attrid/list/action/read/typeid/<?php echo $typeid;?>',  //读取数据的URL
                    update:  SITEURL+'attrid/list/action/save/typeid/<?php echo $typeid;?>',
                    destroy:  SITEURL+'attrid/list/action/delete/typeid/<?php echo $typeid;?>'
                },
                reader: 'json'
            },
            autoLoad: true,
            ...
            viewConfig: {
                ...
                listeners: {
                    ...
                    drop: function (node, data, overModel, dropPosition, eOpts) {
                        ...
                        Ext.Ajax.request({
                            url: SITEURL+'attrid/list/action/drag/typeid/<?php echo $typeid;?>',
                            params: params,
                            method: 'POST',
                ...
                },
                {
                    ...
                    renderer : function(value, metadata,record) {
                        ...
                        if(id.indexOf('add')!=-1 || pid=='0')
                            return '';
                        return '<a href="javascript:;" title="配置" class="row-mod-btn" onclick="attrSet('+id+','+<?php echo $typeid;?>+')"></a>';
                    }
                }
            ],
            plugins: [
...
function addSub(pid) {
    ...
    Ext.Ajax.request({
        method: 'post',
        url: SITEURL+'attrid/list/action/addsub/typeid/<?php echo $typeid;?>',
        params: {pid: pid},
        success: function (response) {
...
function updateField(ele,id,field,value,type,callback)
{
    ...
    Ext.Ajax.request({
        url   :  SITEURL+"attrid/list/action/update/typeid/<?php echo $typeid;?>",
        method  :  "POST",
        datatype  :  "JSON",
