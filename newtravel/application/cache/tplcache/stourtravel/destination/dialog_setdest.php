       ...
       <div class="s-chosen">
            ...
            <div class="chosen-con">
                <?php $n=1; if(is_array($destList)) { foreach($destList as $v) { ?>
                  <span class="chosen-one" id="chosen_item_<?php echo $v['id'];?>" data-rel="<?php echo $v['id'];?>" pid="<?php echo $v['pid'];?>"><label class="lb-tit"><?php echo $v['kindname'];?></label><a href="javascript:;" class="del">x</a></span>
                <?php $n++;}unset($n); } ?>
