            ...
            <div  class="search-bar filter" id="search_bar">
               ...
               <span class="display-mdd">
                  ...
                  <a href="javascript:void(0);" onClick="togMod(this,11,'结伴目的地')"<?php  if($typeid==11) echo 'class="on"';   ?>>结伴</a>
                   <?php $n=1; if(is_array($addmodule)) { foreach($addmodule as $row) { ?>
                      <a href="javascript:void(0);" onClick="togMod(this,<?php echo $row['id'];?>,'<?php echo $row['modulename'];?>目的地')" <?php if($typeid==$row['id']) { ?> class="on"<?php } ?>
><?php echo $row['modulename'];?></a>
                   <?php $n++;}unset($n); } ?>
                </span>
            </div>
