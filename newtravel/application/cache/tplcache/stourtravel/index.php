...
<head>
    <meta charset="utf-8">
    <title><?php echo $configinfo['cfg_webname'];?>-思途CMS4.1</title>
...
<div class="header" id="header">
    <div class="top-page">
        <div class="logo"><img class="fl" src="<?php echo $GLOBALS['cfg_public_url'];?>images/logo.png" alt="思途CMS3.0" title="思途CMS3.0"/></div>
...
<!--<iframe id="indexfrm" src="<?php echo $cmsurl;?>index/index_new" width="100%" height="100%" style="position: absolute;left:0;top:0;z-index:999;border:0"></iframe>-->
...
Ext.onReady(function () {
    ...
    window.gbl_tabs = Ext.create('Ext.tab.Panel', {
        ...
        items: [
            {
                title: '系统主页',
                html: "<iframe src='<?php echo $cmsurl;?>index/index2' width='100%' height='100%' frameborder='0px' ></iframe>",
                listeners: {
                    show: function () {
                       // $("#indexfrm").show();
                        window.currentTab = 0;
...
<?php echo  Stourweb_View::template('stourtravel/public/found');  ?>
</body>
</html>
