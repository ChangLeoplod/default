                ...
                <table class="list-head-tb">
                    <tr>
                        <td class="head-td-lt">
                            ...
                            <a href="javascript:;" class="menu-shortcut" onclick="ST.Util.addTab('<?php echo $menu['name'];?>','<?php echo $menu['url'];?>',1);"><?php echo $menu['name'];?></a>
                            <?php $n++;}unset($n); } ?>
                        </td>
                        <td class="head-td-rt">
...
<script>
 ...
 Ext.tip.QuickTipManager.init();
        ...
        $("#addbtn").click(function(){
            ST.Util.addTab('添加线路','<?php echo $cmsurl;?>line/add/parentkey/product/itemid/1',0);
        });
//线路store
