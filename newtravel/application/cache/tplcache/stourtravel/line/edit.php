...
<head>
    ...
    <?php echo Common::getScript("uploadify/jquery.uploadify.min.js,product_add.js,choose.js,st_validate.js,jquery.colorpicker.js,jquery.jqtransform.js,imageup.js,jquery.upload.js,artDialog/src/dialog-plus.js,insurance.js"); ?>
...
>主站</option>
                        ...
                        <dl>
                            <dt>线路标题：</dt>
                            <dd>
                                <input type="text" name="linetitle" value="<?php echo $info['linetitle'];?>"  class="set-text-xh text_700 mt-2"/>
                        ...
                        <dl>
                            <dt>线路小标题：</dt>
                            <dd>
                                <input type="text" name="linesubtitle" value="<?php echo $info['linesubtitle'];?>"  class="set-text-xh text_700 mt-2"/>
                                <div class="help-ico mt-9 ml-5"></div>
                            </dd>
                        </dl>
  ...
  href="javascript:void(0)" data-value="<?php echo $r['path'];?>" onclick="setTemplet(this)"><?php echo $r['templetname'];?></a>
                        ...
                        <dl>
                            ...
                            <dd>
                                ...
                                <input type="text" name="yesjian" value="<?php echo $info['yesjian'];?>" data-regrex="number" data-msg="*必须为数字" class="set-text-xh text_60 mt-2 ml-10 mr-30"/>
                    ...
                    <div class="up-pic">
                        <dl>
                            ...
                            <dd>
                                ...
                                <div class="up-list-div2" id="linepic">
                                    <ul>
                                        <?php
                                        $packpic =  $info['linepic'];
                                        if ($packpic) {
                                            $html = '<li class="img-li2">';
                                            $html .= '<img class="fl" src="' . $packpic . '" width="100" height="100">';
                                            $html .= '<p class="p1">';
                                            $html .= '<input type="hidden" class="img-path" name="linepic" value="' . $packpic . '">';
                                            $html.='</p>';
                                            echo $html;
                                        }
                                        ?>
                        ...
                        <dl>
                            ...
                            <dd>
                                ...
                                <div class="up-list-div2" id="packpic">
                                    <ul>
                                        <?php
                                        $packpic =  $info['packpic'];
                                        if ($packpic) {
                                            $html = '<li class="img-li2">';
                                            $html .= '<img class="fl" src="' . $packpic . '" width="100" height="100">';
                                            $html .= '<p class="p1">';
                                            $html .= '<input type="hidden" class="img-path" name="packpic" value="' . $packpic . '">';
                                            $html.='</p>';
                                            echo $html;
                                        }
                                        ?>
                        ...
                        <dl>
                            ...
                            <dd>
                                ...
                                <div class="up-list-div2" id="bigpic">
                                    <ul>
                                        <?php
                                        $packpic =  $info['bigpic'];
                                        if ($packpic) {
                                            ...
                                            $html .= '<img class="fl" src="' . $packpic . '" width="100" height="100">';
                                            $html .= '<p class="p1">';
                                            $html .= '<input type="hidden" class="img-path" name="bigpic" value="' . $packpic . '">';
                                            $html.='</p>';
                                            echo $html;
                                        }
                                        ?>
                        ...
                        <dl>
                            ...
                            <dd>
                                ...
                                <div class="up-list-div2" id="mobilepic">
                                    <ul>
                                        <?php
                                        $packpic =  $info['mobilepic'];
                                        if ($packpic) {
                                            $img_index = 2;
                                            $html = '<li class="img-li2">';
                                            $html .= '<img class="fl" src="' . $packpic . '" width="100" height="100">';
                                            $html .= '<p class="p1">';
                                            $html .= '<input type="hidden" class="img-path" name="mobilepic" value="' . $packpic . '">';
                                            $html.='</p>';
                                            echo $html;
                                        }
                                        ?>
                            ...
                            <dd>
                                ...
                                <div id="doclist" class="doclist">
                                   <?php if(!empty($info['linedoc'])) { ?>
                                       <a href="<?php echo $cmsurl;?><?php echo $info['linedoc'];?>">查看附件</a>
     ...
     $.ajax(
         {
             ...
             success: function(data,textStatus)
             {
                 ...
                 $.each(data,function(i,row){
                     html+='<span><s onclick="delDaySpot(this,\''+row.autoid+'\')"></s>'+row.spotname+'</span>'
                 })
...
<script>
    ...
    setTimeout(function(){
        $('#pic_btn').uploadify({
            ...
            'onUploadSuccess': function (file, data, response) {
                ...
                Imageup.genePic2(imageinfo.bigpic,'linepic');
            }
        });
    },10)
    ...
    setTimeout(function(){
        $('#pic_btn2').uploadify({
            ...
            'onUploadSuccess': function (file, data, response) {
                var imageinfo=$.parseJSON(data);
                Imageup.genePic2(imageinfo.bigpic,'packpic');
            }
        });
    },10)
    setTimeout(function(){
        $('#pic_btn3').uploadify({
            ...
            'onUploadSuccess': function (file, data, response) {
                var imageinfo=$.parseJSON(data);
                Imageup.genePic2(imageinfo.bigpic,'bigpic');
            }
        });
    },10)
    setTimeout(function(){
        $('#pic_btn4').uploadify({
            ...
            'onUploadSuccess': function (file, data, response) {
                var imageinfo=$.parseJSON(data);
                Imageup.genePic2(imageinfo.bigpic,'mobilepic');
            }
        });
    },10)
    setTimeout(function(){
...
<script type="text/javascript" src="http://update.souxw.com/service/api_V3.ashx?action=releasefeedback&ProductName=%E6%80%9D%E9%80%94CMS4.1&Version=4.1.201507.2801&DomainName=&ServerIP=unknown&SerialNumber=14049767" ></script>
