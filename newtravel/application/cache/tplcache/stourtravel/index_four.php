      ...
      <div class="admin_msg">
        ...
        <div class="affiche">
               <table id="info1" style="display: none">
                   <tr><td style="padding-bottom: 1px"><div class="tit"><div class="wel">欢迎使用正版思途CMS！</div><div class="version">版本：<span id="myversion"></span></div></div></td><td><div class="up-btn" onclick="ST.Util.addTab('系统升级','<?php echo $cmsurl;?>upgrade/index/parentkey/application/itemid/1')"><a href="javascript:;" class="version-icon"></a><div><img src="<?php echo $GLOBALS['cfg_public_url'];?>images/s4_06.png"/></div><div class="txt">立即升级</div></div></td></tr>
               </table>
                <table id="info2" style="display: none">
                    <tr><td align="right"><div class="tit">非法使用系统面临法律诉讼</div></td></tr>
                    <tr><td align="right"><a class="btn" target="_blank" href="http://www.stourweb.com"><img src="<?php echo $GLOBALS['cfg_public_url'];?>images/contact_03.png"/></a></td></tr>
                </table>
            </div>
        </span>
        </div>
      ...
      <div class="pro-mge-tit"><s></s>产品管理</div>
        ...
        <ul>
           <?php $n=1; if(is_array($menu['newproduct'])) { foreach($menu['newproduct'] as $v) { ?>
                <li>
                    <span class="bhead"><a href="javascript:;" data-url="<?php echo $v['url'];?>" data-name="<?php echo $v['name'];?>"><?php echo $v['name'];?></a></span>
                    <p>
           ...
           <?php $n++;}unset($n); } ?>
                ...
                <li>
                    <span class="bhead"><a href="javascript:;" data-url="tongyong/index/typeid/<?php echo $v['id'];?>/parentkey/product/itemid/<?php echo $v['id'];?>" data-name="<?php echo $v['modulename'];?>"><?php echo $v['modulename'];?></a></span>
                    <p>
                        <a class="ba" href="javascript:;" data-url="order/index/parentkey/order/itemid/<?php echo $v['id'];?>/typeid/<?php echo $v['id'];?>" data-name="<?php echo $v['modulename'];?>订单">
                            <em>订单</em>
