...
>银联</li>
                                  <li class=""><input  type="checkbox" name="qianbao" value="5" <?php if(strpos($config['cfg_pay_type'],'5')!==false) { ?> checked="checked"<?php } ?>
>钱包</li>
                                  <li class=""><input  type="checkbox" name="xianxia" value="6" <?php if(strpos($config['cfg_pay_type'],'6')!==false) { ?> checked="checked"<?php } ?>
>线下支付</li>
                                  <li class=""><input  type="checkbox" name="paypal" value="7" <?php if(strpos($config['cfg_pay_type'],'7')!==false) { ?> checked="checked"<?php } ?>
>贝宝支付</li>
                                  <li class=""><input  type="checkbox" name="weixinpay" value="8" <?php if(strpos($config['cfg_pay_type'],'8')!==false) { ?> checked="checked"<?php } ?>
>微信支付</li>
                              </ul>
                          </td>
                      </tr>
                          ...
                          <div class="pay-one" id="pay_alipay">
                              ...
                              <div class="pay-sg">
                                 <table>
                                  ...
                                  <input id="alipaytype0" type="checkbox" name="alipay_cash" value="11" <?php if(in_array('11',explode(',',$config['cfg_pay_type']))!==false) { ?> checked="checked"<?php } ?>
 ><label for="alipaytype0">即时到帐交易接口</label>
                                  <input id="alipaytype1" type="checkbox" name="alipay_double" value="12" <?php if(in_array('12',explode(',',$config['cfg_pay_type']))!==false) { ?> checked="checked"<?php } ?>
><label for="alipaytype1">双功能</label>
                                  <input id="alipaytype2" type="checkbox" name="alipay_danbao" value="13" <?php if(in_array('13',explode(',',$config['cfg_pay_type']))!==false) { ?> checked="checked"<?php } ?>
><label for="alipaytype2">纯担保交易</label>
                                  <input id="alipaytype3" type="checkbox" name="alipay_bank" value="14" <?php if(in_array('14',explode(',',$config['cfg_pay_type']))!==false) { ?> checked="checked"<?php } ?>
><label for="alipaytype3">网银支付</label>
                                         </td></tr>
                                     <tr>
                              ...
                              <div class="pay-sg">
                                  <table>
                                      <tr>
                                          ...
                                          <td><input name="cfg_qianbao_merchno" type="text" id="cfg_qianbao_merchno" value="<?php echo $config['cfg_qianbao_merchno'];?>" class="set-text inputtext"></td>
                                      </tr>
                                      <tr>
                                          <td class="tit"><span class="tit-sp">密钥(key):</span><div class="help-ico"><?php echo Common::getIco('help',23); ?></div></td>
                                          <td><input name="cfg_qianbao_key" type="text" id="cfg_qianbao_key" value="<?php echo $config['cfg_qianbao_key'];?>"  class="set-text inputtext"></td>
                                      </tr>
                                  </table>
                              </div>
                          </div>
                              ...
                              <div class="pay-sg">
                                  <table>
                                      <tr>
                                          ...
                                          <td><input name="cfg_paypal_key" type="text" id="cfg_paypal_key" value="<?php echo $config['cfg_paypal_key'];?>"  class="set-text inputtext"></td>
                                      </tr>
                                      <tr>
                                          <td class="tit"><span class="tit-sp">币种(currency):</span><div class="help-ico"><?php echo Common::getIco('help',23); ?></div></td>
                                          <td><input name="cfg_paypal_currency" type="text" id="cfg_paypal_currency" value="<?php echo $config['cfg_paypal_currency'];?>"  class="set-text inputtext"></td>
                                      </tr>
                                  </table>
                              </div>
                          </div>
                              ...
                              <div class="pay-sg">
                                  <table>
                                      <tr>
                                          ...
                                          <td><input name="cfg_wxpay_appid" type="text" id="cfg_wxpay_appid" value="<?php echo $config['cfg_wxpay_appid'];?>"  class="set-text inputtext"></td>
                                      </tr>
                                      <tr>
                                          <td class="tit"><span class="tit-sp">受理商ID(MCHID):</span><div class="help-ico"><?php echo Common::getIco('help',23); ?></div></td>
                                          <td><input name="cfg_wxpay_mchid" type="text" id="cfg_wxpay_mchid" value="<?php echo $config['cfg_wxpay_mchid'];?>"  class="set-text inputtext"></td>
                                      </tr>
                                      <tr>
                                          <td class="tit"><span class="tit-sp">密钥(KEY):</span><div class="help-ico"><?php echo Common::getIco('help',23); ?></div></td>
                                          <td><input name="cfg_wxpay_key" type="text" id="cfg_wxpay_key" value="<?php echo $config['cfg_wxpay_key'];?>"  class="set-text inputtext"></td>
                                      </tr>
                                      <tr>
                                          <td class="tit"><span class="tit-sp">开发者(APPSECRET):</span><div class="help-ico"><?php echo Common::getIco('help',23); ?></div></td>
                                          <td><input name="cfg_wxpay_appsecret" type="text" id="cfg_wxpay_appsecret" value="<?php echo $config['cfg_wxpay_appsecret'];?>"  class="set-text inputtext"></td>
                                      </tr>
                                      <tr>
                                          <td class="tit" colspan="2"><span class="tit-sp">请使用ftp上传证书到/shouji/public/thirdpay/weixinpay/WxPayPubHelper/cacert和/thirdpay/weixinpay/cert目录下</span><br><img src="<?php echo $GLOBALS['cfg_public_url'];?>images/wxpay.png" alt="示例图片"/></td>
                                      </tr>
                                  </table>
                              </div>
                          </div>
                          <div class="pay-one" id="pay_chinabank" style="display: none">
                              <div class="pay-nav"><table><tr><td class="tit">支付类型：</td><td><input type="radio" class="yinliantype" name="cfg_yinlian_type" <?php if($config['cfg_yinlian_type']==0) { ?>checked="checked"<?php } ?>
 value="0"/>MD5版&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="cfg_yinlian_type" class="yinliantype" value="1"  <?php if($config['cfg_yinlian_type']==1) { ?>checked="checked"<?php } ?>
/>证书版</td></tr></table></div>
                              <div class="pay-sg">
                                  <table>
                                      <tr>
                             ...
                             <div class="pay-sg">
                                 <table>
                                      <tr>
                                          ...
                                          <td><input name="cfg_yinlian_new_name" type="text" id="cfg_yinlian_new_name" value="<?php echo $config['cfg_yinlian_new_name'];?>" class="set-text inputtext"></td>
                                      </tr>
                                      <tr>
                                          <td class="tit"><span class="tit-sp">密钥:</span><div class="help-ico"><?php echo Common::getIco('help',24); ?></div></td>
                                          <td><input name="cfg_yinlian_new_securitykey" type="text" id="cfg_yinlian_new_securitykey" value="<?php echo $config['cfg_yinlian_new_securitykey'];?>" class="set-text inputtext"></td>
                                      </tr>
                                      <tr>
