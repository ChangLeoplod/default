            ...
            <form id="configfrm">
                ...
                <div class="empower_con">
                    <dl class="ec_list">
                        <dt>思途帐号：</dt>
                        <dd>
                            <input type="text" name="cfg_sms_username" value="<?php echo $configinfo['cfg_sms_username'];?>"  class="set-text text_300" />
                    ...
                    <dl class="ec_list">
                        <dt>思途密码：</dt>
                        <dd>
                            <input type="password" name="cfg_sms_password" value="<?php echo $configinfo['cfg_sms_password'];?>"  class="set-text text_300" />
                    ...
                    <dl class="ec_list">
                        <dt>思途ID：</dt>
                        <dd>
                            <input type="text" name="cfg_licenseid" id="cfg_licenseid" value="<?php echo $serailnum;?>" class="set-text text_300" />
