                   ...
                   <select name="webid" onchange="togWeb(this)"  class="bar-select">
                       ...
                       <?php $weblist=Common::getWeblist()?>
                        <?php $n=1; if(is_array($weblist)) { foreach($weblist as $web) { ?>
                         <option value="<?php echo $web['id'];?>"><?php echo $web['kindname'];?></option>
                        <?php $n++;}unset($n); } ?>
                   </select>
                </div>
        ...
        */
        ...
        window.product_store = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                type: 'ajax',
                api: {
                    read: SITEURL+'order/index/action/read/typeid/<?php echo $typeid;?>',  //读取数据的URL
                    update: SITEURL+'order/index/action/save/typeid/<?php echo $typeid;?>',
                    destroy: SITEURL+'order/index/action/delete/typeid/<?php echo $typeid;?>'
                },
                reader: {
                    type: 'json',   //获取数据的格式
                    root: 'lists',
