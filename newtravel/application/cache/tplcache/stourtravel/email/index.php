...
<!--面包屑-->
    ...
    <div class="manage-nr">
        ...
        <div class="sms-set">
            ...
            <?php echo  Stourweb_View::template('stourtravel/email/reg');  ?>
            <?php echo  Stourweb_View::template('stourtravel/email/line_notice');  ?>
            <?php echo  Stourweb_View::template('stourtravel/email/hotel_notice');  ?>
            <?php echo  Stourweb_View::template('stourtravel/email/car_notice');  ?>
            <?php echo  Stourweb_View::template('stourtravel/email/spot_notice');  ?>
            <?php echo  Stourweb_View::template('stourtravel/email/visa_notice');  ?>
            <?php echo  Stourweb_View::template('stourtravel/email/tuan_notice');  ?>
            </div>
        </div>
    </div>
</td>
