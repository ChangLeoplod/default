...
<body>
      ...
      <div class="content-nr">
          ...
          <div class="manage-nr">
              ...
              <div class="product-add-div" data-id="insured">
                  <div class="add-class">
                      <div class="tourer-nav"><span>当前人数:&nbsp;<label id="tourer_num">0</label></span> &nbsp;&nbsp;&nbsp;<span><a href="javascript:;"  class="tourer-add">添加</a> </span></div>
                      <div class="tourer-container">
                          {loop $tourers $tourer}
                          <div class="wrp">
                          <table class="n-tb">
                              <tr><td class="tit">姓名：</td><td> <input type="text" class="txt" name="tourer[name][]" value="{$tourer['name']}"/><input type="hidden" class="tourer-id" name="tourer[id][]" value="{$tourer['id']}" /><label class="no-blk">*</label></td>
                                  <td class="tit">姓名拼音：</td><td><input type="text" name="tourer[pinyin][]" value="{$tourer['pinyin']}" class="txt"/></td></tr>
                              <tr><td class="tit">证件类型：</td><td><select name="tourer[cardtype][]" class="txt">;
                                ...
                                </td><td class="tit">证件号：</td><td><input type="text" name="tourer[cardcode][]" class="txt" value="{$tourer['cardcode']}" /><label class="no-blk">*</label></td></tr>
                              <tr>
                                  <td class="tit">性别：</td><td><select name="tourer[sex][]" class="txt"><option value="1" {if $tourer['sex']==1}selected="selected"{/if}>男</option><option value="0" {if $tourer['sex']==0}selected="selected"{/if}>女</option></select><label class="no-blk">*</label></td>
                                  <td class="tit">移动电话：</td><td><input type="text" name="tourer[mobile][]" value="{$tourer['mobile']}" class="txt"/></td>
                              </tr>
                              <tr>
                                  <td class="tit">所在地区：</td><td><input type="text" name="tourer[city][]" value="{$tourer['city']}" class="txt"/></td>
                                  <td class="tit">航班号：</td><td><input type="text" name="tourer[fltno][]" value="{$tourer['fltno']}" class="txt"></td>
                              </tr>
                              <tr><td class="tit">职业名称：</td><td><input type="text" class="txt"/></td><td class="tit">职业等级：</td><td><input type="text" class="txt"/></td></tr>
                              <tr><td class="tit">职业代码：</td><td colspan="3"><input type="text" name="tourer[jobcode][]" value="{$tourer['jobcode']}" class="txt"/></td></tr>
                              ...
                              <tr>
                                  <td class="tit">购买份数：</td><td><select name="tourer[count][]" >
                                  ...
                                  </td><td colspan="2" class="btn-td"><a href="javascript:;" class="cp tourer-cpy">复制</a> <a href="javascript:;" class="del tourer-cpy">删除</a></td></tr>
                          </table>
                          </div>



                         <!--  <table class="tourer-tb">
                               <tr><td>姓名：</td><td><input type="text" name="tourer[name][]" value="{$tourer['name']}"/><input type="hidden" class="tourer-id" name="tourer[id][]" value="{$tourer['id']}" /><label class="no-blk">*</label></td></tr>
                               <tr><td>姓名拼音：</td><td><input type="text" name="tourer[pinyin][]" value="{$tourer['pinyin']}"/></td></tr>
                               <tr><td>性别：</td><td><select name="tourer[sex][]"><option value="1" {if $tourer['sex']==1}selected="selected"{/if}>男</option><option value="0" {if $tourer['sex']==0}selected="selected"{/if}>女</option></select><label class="no-blk">*</label></td></tr>
                               <tr><td>证件类型：</td><td><select name="tourer[cardtype][]">
                                           <option value="1" {if $tourer['cardtype']==1}selected="selected"{/if}>身份证</option>
                                           <option value="2" {if $tourer['cardtype']==2}selected="selected"{/if}>军官证</option>
                                           <option value="3" {if $tourer['cardtype']==3}selected="selected"{/if}>护照</option>
                                           <option value="4" {if $tourer['cardtype']==4}selected="selected"{/if}>港澳通行证</option>
                               ...
                               <tr><td>证件号：</td><td><input type="text" name="tourer[cardcode][]" value="{$tourer['cardcode']}" /><label class="no-blk">*</label></td></tr>
                               <tr><td>出生日期：</td><td><input type="text" name="tourer[birthday][]" onclick="WdatePicker()" value="{$tourer['birthday']}"/><label class="no-blk">*</label></td></tr>
                               <tr><td>移动电话：</td><td><input type="text" name="tourer[mobile][]" value="{$tourer['mobile']}"/></td></tr>
                               <tr><td>职业代码：</td><td><input type="text" name="tourer[jobcode][]" value="{$tourer['jobcode']}"/></td></tr>
                               <tr><td>职业等级：</td><td><input type="text" name="tourer[joblevel][]" value="{$tourer['joblevel']}"></td></tr>
                               <tr><td>职业名称：</td><td><input type="text" name="tourer[job][]" value="{$tourer['job']}"/></td></tr>
                               <tr><td>航班号：</td><td><input type="text" name="tourer[fltno][]" value="{$tourer['fltno']}"></td></tr>
                               <tr><td>所在地区：</td><td><input type="text" name="tourer[city][]" value="{$tourer['city']}"/></td></tr>
                               <tr><td>与投保人关系：</td><td><select name="tourer[insurantrelation][]">
                                           <option value="1" {if $tourer['insurantrelation']==1}selected="selected"{/if}>本人</option>
                                           <option value="2" {if $tourer['insurantrelation']==2}selected="selected"{/if}>配偶</option>
                                           <option value="3" {if $tourer['insurantrelation']==3}selected="selected"{/if}>子女</option>
                                           <option value="4" {if $tourer['insurantrelation']==4}selected="selected"{/if}>空</option>
                               ...
                               <tr><td>购买份数：</td><td><input type="text" name="tourer[count][]" value="{$tourer['count']}"/><label class="no-blk">*</label></td></tr>
                               <tr><td colspan="2"><a href="javascript:;" class="tourer-cpy">复制</a>&nbsp;&nbsp;<a href="javascript:;" class="tourer-del" >删除</a></td></tr>
                           </table>
              ...
              <div class="opn-btn">
                     ...
                     <a class="save ml-20" id="btn_gopay" href="javascript:;">支付</a>
	...
	<script>
        ...
        $(document).ready(function() {
            ...
            {
                var pEle=$(this).parents('.tourer-tb:first');
            ...
            $("#product_frm").validate({
                    ...
                    messages: {
                        ...
                        'tourer[cardcode][]':"必填",
                        'tourer[birthday][]':"必填",
                        'tourer[count][]':{required:"必填",digits:'必须为数字'}
        ...
        {
            var pele= $(btn).parents(".tourer-tb:first");
            var dataArr=[];
        ...
        function addTourer(dataArr)
        {
         ...
         html+='<tr><td class="tit">姓名：</td><td> <input type="text" class="txt" name="tourer[name][]" value=""/><input type="hidden" class="tourer-id" name="tourer[id][]" value="" /><label class="no-blk">*</label></td>';
         html+='<td class="tit">姓名拼音：</td><td><input type="text" name="tourer[pinyin][]" value="" class="txt"/></td></tr>';
         html+='<tr><td class="tit">证件类型：</td><td><select name="tourer[cardtype][]" class="txt">';
         ...
         html+='</td><td class="tit">证件号：</td><td><input type="text" name="tourer[cardcode][]" class="txt" value="" /><label class="no-blk">*</label></td></tr>';
         html+='<tr><td class="tit">性别：</td><td><select name="tourer[sex][]" class="txt"><option value="1" >男</option><option value="0" >女</option></select><label class="no-blk">*</label></td>';
         html+='<td class="tit">移动电话：</td><td><input type="text" name="tourer[mobile][]" value="" class="txt"/></td></tr>';
         html+='<tr><td class="tit">所在地区：</td><td><input type="text" name="tourer[city][]" value="" class="txt"/></td>';
         html+='<td class="tit">航班号：</td><td><input type="text" name="tourer[fltno][]" value="" class="txt"></td></tr>';
         html+='<tr><td class="tit">职业名称：</td><td><input type="text" class="txt"/></td><td class="tit">职业等级：</td><td><input type="text" class="txt"/></td></tr>';
        <tr><td class="tit">职业代码：</td><td colspan="3"><input type="text" name="tourer[jobcode][]" value="{$tourer['jobcode']}" class="txt"/></td></tr>
        <tr><td class="tit">与投保人关系：</td><td colspan="3"><select name="tourer[insurantrelation][]">
        <option value="1" {if $tourer['insurantrelation']==1}selected="selected"{/if}>本人</option>
        <option value="2" {if $tourer['insurantrelation']==2}selected="selected"{/if}>配偶</option>
        ...
        function showNum()
        {
            $("#tourer_num").text($(".tourer-tb").length);
        }
    </script>
