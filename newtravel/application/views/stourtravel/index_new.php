...
<div class="gn-ts-cum">
    ...
    <p id="newversion" style="display: none">系统有新版本发布，建议升级！<a href="javascript:;" onclick="ST.Util.addTab('系统升级','{$cmsurl}upgrade/index/parentkey/application/itemid/1')">立即升级</a></p>
    <a class="back-ico" href="javascript:;" onclick="parent.window.hideIndex()">返回</a>
</div>

<div class="best_news" style="display: none">
	<p class="tit">我的版本:<span id="myversion"></span> &nbsp;&nbsp;最新版本<span id="new_version"></span>&nbsp;&nbsp;<span id="new_pubdate"></span>&nbsp;&nbsp;星期四&nbsp;&nbsp;改进</p>
...
<div class="hide-con-box">
    <div class="ma-wid_1000">
        ...
        <div class="list-box" id="test3">
            ...
            {/loop}
            {loop $addmodule $v}
            <a href="javascript:;" data-url="order/index/parentkey/order/itemid/{$v['id']}/typeid/{$v['id']}"><img src="{$GLOBALS['cfg_public_url']}images/tongyong.png" /><span>{$v['modulename']}</span></a>
            {/loop}
        </div>
...
<script language="JavaScript">
    ...
    {
        $.ajax({
            url: SITEURL+"upgrade/ajax_check_right",
            dataType: 'json',
            success: function(data){
