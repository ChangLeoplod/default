    ...
    <tr>
        ...
        <td valign="top" class="content-rt-td" style="overflow:hidden">
            <div class="crumbs" id="attr_crumbs">
                <label>位置：</label>
                <a href="javascript:;">首页</a> &gt; <a href="javascript:;">设置中心</a> &gt; <a href="javascript:;">基础设置</a> &gt; <span>属性设置</span>
            </div>
...
Ext.onReady(
    function () {
        ...
        $(".w-set-tit").find('#tb_lineattr').addClass('on');
        ...
        window.attr_store = Ext.create('Ext.data.TreeStore', {
            ...
            proxy: {
                ...
                api: {
                    read: SITEURL+'line/attr/action/read',  //读取数据的URL
                    update:  SITEURL+'line/attr/action/save',
                    destroy:  SITEURL+'line/attr/action/delete'
                },
                reader: 'json'
            },
            autoLoad: true,
...
function addSub(pid) {
    ...
    Ext.Ajax.request({
        method: 'post',
        url: SITEURL+'line/attr/action/addsub',
        params: {pid: pid},
        success: function (response) {
...
function updateField(ele,id,field,value,type)
{
    ...
    Ext.Ajax.request({
        url   :  SITEURL+"line/attr/action/update",
        method  :  "POST",
        datatype  :  "JSON",
