                ...
                <div id="content_basic" class="product-add-div content-show">
                    <div class="add-class">
                        ...
                        <dl>
                            <dt>线路标题：</dt>
                            <dd>
                                <input type="text" name="linetitle" value="{$info['linetitle']}"  class="set-text-xh text_700 mt-2"/>
                        ...
                        <dl>
                            <dt>线路小标题：</dt>
                            <dd>
                                <input type="text" name="linesubtitle" value="{$info['linesubtitle']}"  class="set-text-xh text_700 mt-2"/>
                    ...
                    <div class="add-class">
                        ...
                        <dl>
                            ...
                            <dd>
                                ...
                                <input type="text" name="yesjian" value="{$info['yesjian']}" data-regrex="number" data-msg="*必须为数字" class="set-text-xh text_60 mt-2 ml-10 mr-30"/>
