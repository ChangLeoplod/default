    ...
    function () {
        ...
        window.product_store = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                type: 'ajax',
                api: {
                    read: SITEURL+'question/index/action/read',  //读取数据的URL
                    update: SITEURL+'question/index/action/save',
                    destroy: SITEURL+'question/index/action/delete'
                },
                reader: {
                    type: 'json',   //获取数据的格式
                    root: 'lists',
            ...
            columns: [
                ...
                },
                {
                    ...
                    renderer: function (value, metadata, record) {
                        ...
                        if(value==0){
                            return '<span>产品问题</span>';
                        }
                        else{
                            return '<span>普通问题</span>';
                        }
                ...
                },
                {
                    ...
                    renderer: function (value, metadata, record) {
                        ...
                        var html = "<a href='javascript:void(0);' class='row-mod-btn' onclick=\"view(" + id + ")\"></a>";
                            html+= "&nbsp;&nbsp;"
                            html+= "<a href='javascript:void(0);' class='row-del-btn' onclick=\"delS(" + id + ")\"></a>";
                        return html;
