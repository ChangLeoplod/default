...
Ext.onReady(
    function () {
        ...
        $("#addbtn").click(function(){
            ...
            ST.Util.showBox('添加图标',url,'400','600',function(){window.product_store.load()});
        });
            ...
            columns: [
                ...
                },
                {
                    ...
                    renderer: function (value, metadata, record) {
                        ...
                        return '<input type="text" class="row-edit-txt" style="text-align:left;width:100px" value="'+value+'" onblur="updateField(this,\''+id+'\',\'displayorder\',0,\'input\')"/>';
                    }
...

                {
                    ...
                    menuDisabled:true,
                    renderer: function (value, metadata, record) {
                        var html="<img src="+value+"  border='0'/>";
                        return html;
                    }
...

                {
                    ...
                    renderer: function (value, metadata, record) {
                        ...
                        var id = record.get('id');
                        var html = "<a href='javascript:void(0);' class='row-mod-btn' onclick=\"modify(" + id + ")\"></a>&nbsp;&nbsp;&nbsp; <a href='javascript:void(0);' class='row-del-btn' onclick=\"delS(" + id + ")\"></a>";
                        return html;
...
function modify(id)
{
    ...
    ST.Util.showBox('修改图标信息',url,410,200,function(){window.product_store.load()});
}
