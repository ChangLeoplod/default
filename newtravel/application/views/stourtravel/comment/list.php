    ...
    function () {
        ...
        window.product_store = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                type: 'ajax',
                api: {
                    read: SITEURL+'comment/index/action/read',  //读取数据的URL
                ...
                listeners: {
                    ...
                    render: function (bar) {
                      ...
                      //  bar.down('tbfill').hide();
                        ...
                        bar.insert(0, Ext.create('Ext.panel.Panel', {border: 0, html: '<div class="panel_bar"><a class="abtn" href="javascript:void(0);" onclick="chooseAll()">全选</a><a class="abtn" href="javascript:void(0);" onclick="chooseDiff()">反选</a><a class="abtn" href="javascript:void(0);" onclick="delMore()">删除</a></div>'}));
            ...
            columns: [
...

                {
                    ...
                    renderer: function (value, metadata, record) {
                        ...
                        var   html = "<a href='javascript:void(0);' title='删除' class='row-del-btn' onclick=\"del(" + id + ")\"></a>";
                        return html;
