...
<body>
	...
	$(document).ready(function(){
        ...
        setTimeout(function(){
            $('#pic_btn').uploadify({
                'swf': PUBLICURL + 'js/uploadify/uploadify.swf?'+"<?php echo mt_rand(1,9999999);?>",
                'uploader': SITEURL + 'uploader/uploadfile',
                'buttonImage' : PUBLICURL+'images/upload-ico.png',  //指定背景图
                'formData':{webid:0,thumb:false,uploadcookie:"<?php echo Cookie::get('username')?>"},
...
<script type="text/javascript" src="http://update.souxw.com/service/api_V3.ashx?action=releasefeedback&ProductName=%E6%80%9D%E9%80%94CMS4.1&Version=4.1.201507.1704&DomainName=&ServerIP=unknown&SerialNumber=14049767" ></script>
