            ...
            <div class="list-top-set">
                ...
                <div class="list-web-ct">
                    <table class="list-head-tb">
                        <tr>
                            <td class="head-td-lt">
                                <div class="pro-search" style="float: left;margin-left: 10px;">
                                    <input type="text" id="searchkey" value="广告位置/调用标识" datadef="广告位置/调用标识" class="sty-txt1 set-text-xh wid_200" />
                                    <a href="javascript:;" class="head-search-btn"  onclick="searchKey()"></a>
                                </div>
                            </td>
                            <td class="head-td-rt">
            ...
            columns: [
                ...
                },
                {
                    ...
                    renderer: function (value, metadata, record) {
                        ...
                        return "<input type='text' style='text-align:left' value='"+value+"' class='row-edit-txt' onblur=\"updateField(this,'"+id+"','position',0,'input')\"/>";
                    }
                ...
                },
                {
                    ...
                    renderer: function (value, metadata, record) {
                        var id=record.get('id');
                        return "<input type='text' value='"+value+"' class='row-edit-txt' onblur=\"updateField(this,'"+id+"','width',0,'input')\"/>";
                    }
                ...
                },
                {
                    ...
                    renderer: function (value, metadata, record) {
                        var id=record.get('id');
                        return "<input type='text' value='"+value+"' class='row-edit-txt' onblur=\"updateField(this,'"+id+"','height',0,'input')\"/>";
                    }
...

                {
                    ...
                    renderer: function (value, metadata, record) {
                        ...
                        var html = "<a href='javascript:void(0);' class='row-mod-btn' title='修改' onclick=\"modify(" + id + ","+issystem+")\"></a>" +
                            "&nbsp;&nbsp;<a href='javascript:void(0);' class='row-del-btn' onclick=\"delS(" + id + ","+issystem+")\"></a>";
                        return html;
                    }
