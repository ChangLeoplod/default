    ...
    function () {
        ...
        window.product_store = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                type: 'ajax',
                api: {
                    read: SITEURL+'userlog/index/action/read',  //读取数据的URL
                    update: SITEURL+'userlog/index/action/save',
                    destroy: SITEURL+'userlog/index/action/delete'
                },
                reader: {
                    type: 'json',   //获取数据的格式
                    root: 'lists',
