        ...
        <div class="filter">
              <div id="agent_choose">
                  ...
                  <select name="type" id="type" class="bd_style wid_100" onchange="goSearch(this.value,'type')">
                      ...
                      <option value="1">未设置tag词</option>

                  </select>

              </div>
            <div class="pro-search" style="float: left;margin-top: 4px;">
                <input type="text" id="searchkey" value="tag词" datadef="tag词" class="searchkey sty-txt1 set-text-xh wid_200 ml10" />
    ...
    function() 
    {
        ...
        window.product_store=Ext.create('Ext.data.Store',{
         ...
         proxy:{
		   type:'ajax',
		   api: {
              read: SITEURL+'tagword/index/action/read',  //读取数据的URL
			  update:SITEURL+'tagword/index/action/save',
              destroy:SITEURL+'tagword/index/delete'
	   ...
	   columns:[
			   ...
			   },
               {
                   ...
                   renderer : function(value, metadata,record) {
                       ...
                       return "<input type='text' value='"+value+"' class='row-edit-txt' style='text-align:left' onblur=\"updateField(this,'"+id+"','tagword',0,'input')\"/>";
                   }
