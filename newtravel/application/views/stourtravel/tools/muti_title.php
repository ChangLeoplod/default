                        ...
                        <div class="titleset-box">
                            ...
                            <div class="tit-list-box">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <th height="120" align="right" valign="top" scope="row"><span class="fr pt-5">优化描述：</span></th>
                                        <td width="480"><textarea name="cfg_article_desc" cols="" rows="" class="dft-area pl-5">{$info['cfg_article_title']}</textarea></td>
                                        <td width="310"></td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div class="tit-list-box">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <th height="120" align="right" valign="top" scope="row"><span class="fr pt-5">优化描述：</span></th>
                                        <td width="480"><textarea name="cfg_spot_desc" cols="" rows="" class="dft-area pl-5">{$info['cfg_spot_title']}</textarea></td>
                                        <td width="310"></td>
                                    </tr>
                                </table>
                            </div>
