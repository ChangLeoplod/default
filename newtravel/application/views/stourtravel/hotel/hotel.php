...
Ext.onReady(
    function () {
        ...
        window.product_store = Ext.create('Ext.data.Store', {
            ...
            fields: ['id', 'aid', 'webid', 'hotelname', 'hotelrankid', 'telephone', 'hotelkind', 'fuwu', 'shownum', 'kindlist', 'attrid', 'ishidden', 'displayorder', 'kindname', 'iconlist', 'attrname', 'themelist', 'tr_class', 'price', 'sellprice', 'breakfirst', 'computer'],
            proxy: {
                type: 'ajax',
                api: {
