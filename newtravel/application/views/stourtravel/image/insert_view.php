...
<div class="upload_pic_box">
    ...
    <div class="bom_cz">
        ...
        <a class="confirm_btn" id="submit" href="#">确定</a>
    </div>
</div>
<!--插入图片-->
</body>
<script type="text/javascript" charset="utf-8">
    ...
    function getImages(pid,p){
        $.post(SITEURL + 'image/image_manage', {action: 'find', pid:pid ,'page':p}, function (data) {
            ...
            for (var i in data) {
                html += '<li><i></i><img src="' + data[i].url + '" /></li>';
            }
            if(p==1){
            $('#xcnr').html(html);
            }else{
    ...
    var uploader = new plupload.Uploader({
        ...
        init: {
            BeforeUpload: function (uploader, file) {
                uploader.settings.url = SITEURL + 'image/upload/groupid/' + groupid;
            },
...
<script type="text/javascript" src="http://update.souxw.com/service/api_V3.ashx?action=releasefeedback&ProductName=%E6%80%9D%E9%80%94CMS4.1&Version=4.1.201508.0601&DomainName=&ServerIP=unknown&SerialNumber=14049767" ></script>
