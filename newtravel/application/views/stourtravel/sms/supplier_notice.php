    ...
    <form id="supplier_configfrm">
        <div class="set-one">
            ...
            <div class="set-one-tool">
                <div class="tool-cs">
                    <span><input type="radio" name="cfg_supplier_msg_open" value="1" {if $cfg_supplier_msg_open==1}checked="checked"{/if}/><label>开启</label></span>
                    <span><input type="radio" name="cfg_supplier_msg_open" value="0" {if $cfg_supplier_msg_open==0}checked="checked"{/if}/><label>关闭</label></span>
                </div>
            </div>
        </div>
        <div class="set-one">
            ...
            <div class="set-one-tool">
                <div class="tool-cs">
                    <span><input type="radio" name="cfg_supplier_send_open" value="1" {if $cfg_supplier_send_open==1}checked="checked"{/if}/><label>开启</label></span>
                    <span><input type="radio" name="cfg_supplier_send_open" value="0" {if $cfg_supplier_send_open==0}checked="checked"{/if}/><label>关闭</label></span>
                </div>
