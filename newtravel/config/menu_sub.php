...
return array(
    ...
    'article'=>array(
        'article'=>array('name'=>'文章','url'=>'article/article/parentkey/article/itemid/1','itemid'=>'1','ico'=>'wz-ico.png'),
        'spot2'=>array('name'=>'景点','url'=>'spot/spot/parentkey/article/itemid/2','itemid'=>'2','ico'=>'jd-ico.png'),
        'photo'=>array('name'=>'相册','url'=>'photo/photo/parentkey/article/itemid/3','itemid'=>'3','ico'=>'xc-ico.png'),
        'question'=>array('name'=>'问答','url'=>'question/index/parentkey/article/itemid/4','itemid'=>'4','ico'=>'wd-ico.png'),
        'pinlun'=>array('name'=>'评论','url'=>'comment/index/parentkey/article/itemid/5','itemid'=>'5','ico'=>'pl-ico.png'),
        'help'=>array('name'=>'帮助','url'=>'help/list/parentkey/article/itemid/6','itemid'=>'6','ico'=>'bz-ico.png'),
    ...
    'order'=>array(
        ...
        'xyorder'=>array('name'=>'自定义订单','url'=>'order/xy/parentkey/order/itemid/15/','itemid'=>'15','ico'=>'chindren-ico-61.png'),
		'insorder'=>array('name'=>'保险订单','url'=>'insurance/book/parentkey/order/itemid/7/','itemid'=>'7')

    ),
    'basic'=>array(

        'nav'=>array('name'=>'主导航','url'=>'config/mainnav/parentkey/basic/itemid/1','itemid'=>'1','ico'=>'chindren-ico-56.png'),
        'usernav'=>array('name'=>'自定义导航','url'=>'app/topusernav/parentkey/basic/itemid/10','itemid'=>'10','ico'=>'chindren-ico-63.png'),
        'footernav'=>array('name'=>'底部导航','url'=>'footernav/index/parentkey/basic/itemid/2','itemid'=>'2','ico'=>'chindren-ico-06.png'),
        'footer'=>array('name'=>'网页底部','url'=>'config/footer/parentkey/basic/itemid/3','itemid'=>'3','ico'=>'chindren-ico-37.png'),
        'logo'=>array('name'=>'logo设置','url'=>'config/logo/parentkey/basic/itemid/4','itemid'=>'4','ico'=>'chindren-ico-59.png'),
        'index'=>array('name'=>'首页设置','url'=>'config/base/parentkey/basic/itemid/5','itemid'=>'5','ico'=>'chindren-ico-30.png'),
        'gonggao'=>array('name'=>'公告设置','url'=>'config/gonggao/parentkey/basic/itemid/6','itemid'=>'6','ico'=>'chindren-ico-10.png'),
        'kefu'=>array('name'=>'客服设置','url'=>'kefu/phone/parentkey/basic/itemid/7','itemid'=>'7','ico'=>'chindren-ico-19.png'),
        'site'=>array('name'=>'子站管理','url'=>'site/index/parentkey/basic/itemid/9','itemid'=>'9','ico'=>'chindren-ico-51.png'),
        'authright'=>array('name'=>'授权管理','url'=>'config/authright/parentkey/basic/itemid/11','itemid'=>'11','ico'=>'chindren-ico-51.png')
    ...
    'kind'=>array(
        ...
        'destattr'=>array('name'=>'目的地属性','url'=>'attrid/list/parentkey/kind/itemid/12/typeid/12','itemid'=>'12'),
        ...
        'photo'=>array('name'=>'相册分类','url'=>'attrid/list/parentkey/kind/itemid/10/typeid/6','itemid'=>'10','ico'=>'chindren-ico-47.png'),
    ...
    'hotelkind'=>array(
        ...
        'hoteldest'=>array('name'=>'酒店目的地','url'=>'destination/destination/parentkey/kind/itemid/4/typeid/2','itemid'=>4),
	...
	'carkind'=>array(
		 ...
		 'cartype'=>array('name'=>'车型分类','url'=>'car/kind/parentkey/kind/itemid/5','itemid'=>3),
		 'carattr'=>array('name'=>'属性分类','url'=>'attrid/list/parentkey/kind/itemid/5/typeid/3','itemid'=>5),
         'carjieshao'=>array('name'=>'内容介绍','url'=>'attrid/content/parentkey/kind/itemid/5/typeid/3','itemid'=>5),
         'cardest'=>array('name'=>'租车目的地','url'=>'destination/destination/parentkey/kind/itemid/5/typeid/3','itemid'=>5),
    ...
    'spotkind'=>array(
		 ...
		 'spotdest'=>array('name'=>'景点目的地','url'=>'destination/destination/parentkey/kind/itemid/6/typeid/5','itemid'=>6),
    ...
    'tuankind'=>array(
		   ...
		   'tuandest'=>array('name'=>'团购目的地','url'=>'destination/destination/parentkey/kind/itemid/8/typeid/13','itemid'=>8),
    ...
    'articlekind'=>array(
        ...
        'articledest'=>array('name'=>'文章目的地','url'=>'destination/destination/parentkey/kind/itemid/9/typeid/4','itemid'=>9),
    ...
    'photokind'=>array(
        ...
        'photodest'=>array('name'=>'相册目的地','url'=>'destination/destination/parentkey/kind/itemid/10/typeid/6','itemid'=>10),
    ...
    'kefukind'=>array(
        'phone'=>array('name'=>'客服电话','url'=>'kefu/phone/parentkey/kefukind/itemid/1','itemid'=>'1'),
        'hotelprice'=>array('name'=>'QQ客服','url'=>'kefu/qq/parentkey/kefukind/itemid/2','itemid'=>'2'),
        'hotelattr'=>array('name'=>'第三方客服','url'=>'kefu/other/parentkey/kefukind/itemid/3','itemid'=>'3'),

    ),
    'jiebankind'=>array(
        'jiebandest'=>array('name'=>'结伴目的地','url'=>'destination/destination/parentkey/kind/itemid/20/typeid/11','itemid'=>20),
        'jiebanattr'=>array('name'=>'结伴主题','url'=>'attrid/list/parentkey/kind/itemid/21/typeid/11','itemid'=>'21')

    ),
    'templet'=>array(
         'templet'=>array('name'=>'模板管理','url'=>'templet/index/parentkey/templet/itemid/1','itemid'=>'1','ico'=>'chindren-ico-22.png'),
         'module'=>array('name'=>'模块管理','url'=>'module/index/parentkey/templet/itemid/2','itemid'=>'2','ico'=>'chindren-ico-24.png')
    ...
    'sale'=>array(
        'advertise'=>array('name'=>'广告策略','url'=>'advertise/index/parentkey/sale/itemid/1','itemid'=>'1','ico'=>'chindren-ico-13.png'),
        'theme'=>array('name'=>'专题策略','url'=>'zhuanti/list/parentkey/sale/itemid/2','itemid'=>'2','ico'=>'chindren-ico-57.png'),
        'flink'=>array('name'=>'友情链接','url'=>'friendlink/list/parentkey/sale/itemid/3','itemid'=>'3','ico'=>'chindren-ico-50.png'),
        'exchange'=>array('name'=>'积分策略','url'=>'exchange/set/parentkey/sale/itemid/4','itemid'=>'4','ico'=>'chindren-ico-67.png'),
        'jieban'=>array('name'=>'结伴','url'=>'jieban/index/parentkey/sale/itemid/5','itemid'=>'5','ico'=>'chindren-ico-67.png')

    ),
    'system'=>array(
        'pay'=>array('name'=>'支付接口','url'=>'config/payset/parentkey/system/itemid/1','itemid'=>'1','ico'=>'chindren-ico-52.png'),
        'payment'=>array('name'=>'签约流程','url'=>'config/payment/parentkey/system/itemid/2','itemid'=>'2','ico'=>'chindren-ico-26.png'),
        'msg'=>array('name'=>'短信接口','url'=>'sms/index/parentkey/system/itemid/3','itemid'=>'3','ico'=>'chindren-ico-42.png'),
        'ordermail'=>array('name'=>'订单提醒','url'=>'config/ordermail/parentkey/system/itemid/16','itemid'=>'16','ico'=>'chindren-ico-41.png'),
        'email'=>array('name'=>'邮箱接口','url'=>'config/mailport/parentkey/system/itemid/14','itemid'=>'14','ico'=>'chindren-ico-40.png'),
        'thirdpart'=>array('name'=>'第三方登陆','url'=>'config/thirdpart/parentkey/system/itemid/4','itemid'=>'4','ico'=>'chindren-ico-29.png'),
        'weibo'=>array('name'=>'微信微博','url'=>'config/wx/parentkey/system/itemid/5','itemid'=>'5','ico'=>'chindren-ico-38.png'),
        'icon'=>array('name'=>'图标管理','url'=>'icon/index/parentkey/system/itemid/6','itemid'=>'6','ico'=>'chindren-ico-35.png'),
        'water'=>array('name'=>'水印设置','url'=>'config/watermark/parentkey/system/itemid/8','itemid'=>'8','ico'=>'chindren-ico-33.png'),
        'nophoto'=>array('name'=>'无图设置','url'=>'config/nopic/parentkey/system/itemid/9','itemid'=>'9','ico'=>'chindren-ico-43.png'),
        'webico'=>array('name'=>'网站头像','url'=>'config/webico/parentkey/system/itemid/13','itemid'=>'13','ico'=>'chindren-ico-68.png'),
        'sys'=>array('name'=>'系统参数','url'=>'config/syspara/parentkey/system/itemid/10','itemid'=>'10','ico'=>'chindren-ico-44.png'),
        'databack'=>array('name'=>'数据备份','url'=>'databackup/index/parentkey/system/itemid/11','itemid'=>'11','ico'=>'chindren-ico-31.png'),
        'ucenter'=>array('name'=>'ucenter配置','url'=>'config/ucenter/parentkey/system/itemid/12','itemid'=>'12','ico'=>'chindren-ico-66.png'),
    ...
    'tool'=>array(
        'tongji'=>array('name'=>'统计代码','url'=>'config/tongji/parentkey/tool/itemid/1','itemid'=>'1','ico'=>'chindren-ico-34.png'),
        'robots'=>array('name'=>'robots设置','url'=>'config/robots/parentkey/tool/itemid/2','itemid'=>'2','ico'=>'chindren-ico-60.png'),
        'keyword'=>array('name'=>'关键词统计','url'=>'keyword/index/parentkey/tool/itemid/3','itemid'=>'3','ico'=>'chindren-ico-12.png'),
        'seolink'=>array('name'=>'智能内链','url'=>'toollink/index/parentkey/tool/itemid/4','itemid'=>'4','ico'=>'chindren-ico-54.png'),
        'mutititle'=>array('name'=>'批量Title','url'=>'app/mutititle/parentkey/tool/itemid/5','itemid'=>'5','ico'=>'chindren-ico-64.png'),
        'tagword'=>array('name'=>'Tag管理','url'=>'tagword/index/parentkey/tool/itemid/6','itemid'=>'6','ico'=>'chindren-ico-01.png'),
        'ourtj'=>array('name'=>'来源分析','url'=>'visit/index/parentkey/tool/itemid/7','itemid'=>'7','ico'=>'chindren-ico-55.png'),
        'sitemap'=>array('name'=>'Sitemap','url'=>'sitemap/index/parentkey/tool/itemid/8','itemid'=>'8','ico'=>'chindren-ico-53.png'),
        'dielink'=>array('name'=>'死链排查','url'=>'sitemap/errorlink/parentkey/tool/itemid/9','itemid'=>'9','ico'=>'chindren-ico-65.png'),
        'hotsearch'=>array('name'=>'热搜词分析','url'=>'hotsearch/index/parentkey/tool/itemid/10','itemid'=>'10','ico'=>'chindren-ico-28.png'),
        'log'=>array('name'=>'操作日志','url'=>'userlog/index/parentkey/tool/itemid/11','itemid'=>'11','ico'=>'chindren-ico-03.png')
  ...
  /* 'rightlist'=>array(
       ...
       'line'=>array(
           'add'=>array('line','sadd'),
           'edit'=>array('line','sedit'),
           'list'=>array('line','slook,sdelete'),
           'price'=>array('lineprice','lineprice')
