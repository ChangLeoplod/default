    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'print', 'preview', 'searchreplace', 'help', 'drafts','insertkind','insertsubtitle','autosave']
        ]
        //当鼠标放在工具栏上时显示的tooltip提示,留空支持自动多语言配置，否则以配置值为准
        ,labelMap:{
            'anchor':'', 'undo':'','insertkind':'使用官方攻略模板时，对内容进行分类，生成分类导航','insertsubtitle':'添加官方攻略模板中，分类信息的标题，用于内容索引'
        }
        //webAppKey
        ...
        ,initialFrameWidth:10500  //初始化编辑器宽度,默认1000
        ,initialFrameHeight:820  //初始化编辑器高度,默认320
