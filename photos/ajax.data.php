...
if($dopost=='getdata')
{
	...
	$str.="<div class=\"item\">";
        ...
        $str.="<a href=\"/photos/show_{$row['aid']}_{$row['headimgid']}.html\"><img class=\"resizeme\" alt=\"{$row['photoname']}\" src=\"{$row['litpic']}\" width=\"210\" /></a><span class=\"price\"><h3>{$row['photoname']}</h3><span>关注：{$row['shownum']}</span></span></div>";
              
            
            
        $str.="<div class=\"title\"><span>{$row['photoname']}</span></div></div>";
