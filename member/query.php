...
class QueryOrder{
    ...
    public static function getProductInfo($id,$typeid,$productname='')
    {
        ...
        $fields=array(
            '1'=>array('field'=>'linename as title,sellpoint,linepic as litpic','link'=>'lines'),
            '2'=>array('field'=>'hotelname as title, sellpoint,litpic','link'=>'hotels'),
            '3'=>array('field'=>'carname as title,sellpoint,litpic','link'=>'cars'),
            '4'=>array('field'=>'articlename','link'=>'article'),
            '5'=>array('field'=>'spotname as title,sellpoint,litpic','link'=>'spots'),
