...
if(!empty($dest_id) && !empty($attrid))
{
    ...
    $sql = "select a.* from #@__article a left join {$left_table} on (b.classid='$attrid' and a.id=b.aid  and b.typeid=4 and b.destid='$dest_id') {$where} order by b.isding desc,b.displayorder asc,a.modtime desc,a.addtime desc";
}
else
{
