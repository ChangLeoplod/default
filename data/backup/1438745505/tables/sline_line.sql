CREATE TABLE `sline_line` (
  ...
  `linetitle` varchar(255) NOT NULL COMMENT '线路标题',
  `linesubtitle` varchar(255) NOT NULL COMMENT '线路小标题',
  ...
  `packpic` varchar(255) NOT NULL COMMENT '套餐封面图',
  `mobilepic` varchar(255) NOT NULL COMMENT '移动端封面图',
  PRIMARY KEY (`id`),
