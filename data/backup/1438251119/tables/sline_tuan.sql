CREATE TABLE `sline_tuan` (
  ...
  `ourprice` int(11) DEFAULT NULL COMMENT '优惠价',
  ...
  `isjian` int(1) unsigned DEFAULT '0',
  `isding` int(1) unsigned DEFAULT '0',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='团购表'