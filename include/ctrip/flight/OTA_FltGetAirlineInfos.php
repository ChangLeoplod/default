...
class OTA_FltGetAirlineInfos
{
	public $open_api = '/Flight/FlightProduct/OTA_FltGetAirlineInfos.asmx';
	...
	public function __construct($open_api,$args)
	{
        ...
        $this->airline_code = $args['airline_code'];
	...
	public function request_xml( $uid, $sid, $stmp, $sign, $type )
	{
        ...
        $request_xml =
          ...
          .'<Request>'
          .'<Header AllianceID="'.$uid.'" SID="'.$sid.'" TimeStamp="'.$stmp.'" RequestType="OTA_FltGetAirlineInfos" Signature="'.$sign.'" />'
          .'<GetAirlineInfosRequest>'
          .'<AirLine>'.$this->airline_code.'</AirLine>'
          .'</GetAirlineInfosRequest>'
          .'</Request>';
