<?php
    ...
    $imgSavePathConfig = '../../../uploads/arcimgs/';
    //上传配置
    $config = array(
   ...
   /* //上传目录验证
    ...
    $config['savePath'] = $imgSavePathConfig;
     ...
     */
    //特殊处理
    $fileurl = str_replace('../../..',$GLOBALS['cfg_basehost'],$info['url']);
    echo "{'url':'" . $fileurl . "','title':'" . $title . "','original':'" . $info["originalName"] . "','state':'" . $info["state"] . "'}";
