...
function lib_getthemelist(&$ctag,&$refObj)
{
	...
	if(!empty($typeid))
	{
	   ...
	   {
		   case 1:
		     $fields="a.aid,a.id,a.webid,a.linename as title,a.seotitle,a.sellpoint,a.linepic,a.storeprice,a.lineprice,a.linedate,a.transport,a.lineday,a.startcity,a.overcity,a.shownum,a.satisfyscore,a.bookcount";
			 $orderby=" order by a.isding desc,a.displayorder asc";
			 break;
		  case 2:
		     $fields=" a.*,a.hotelname as title ";
			 $orderby=" order by a.isding desc,a.displayorder asc";
			 break;
		  case 3:
		     $fields=" a.*,a.carname as title";
			 $orderby=" order by a.istop desc";
			 break;
		  case 4:
		     $fields=" a.aid,a.webid,a.allow,a.articlename as title,a.seoname,a.shownum,a.content,a.addtime,a.webid,a.attrid,a.litpic ";
			 $orderby=" order by a.isding desc,displayorder asc";
			 break;
		  case 5:
		     $fields=" a.aid,a.id,a.spotname as title,a.isspotarea,a.litpic,a.doorprice,a.area,a.spotpicid,a.tagword,a.kindlist,a.webid,a.attrid ";
			 $orderby=" order by a.isding desc,displayorder asc";
			 break;
		  case 6:
		     $fields=" a.aid,a.photoname,a.seoname,a.headimg,a.imginfo,a.title as littitle,a.alt,a.author,a.shownum,a.webid,a.headimgid";
