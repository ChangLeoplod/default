...
function lib_getlinelist(&$ctag,&$refObj)
{
    ...
    $revalue = '';
	$basefield = "a.aid,a.id,a.webid,a.linename,a.lineicon,a.seotitle,a.sellpoint,a.linepic,a.storeprice,a.lineprice,a.linedate,a.features,a.transport,a.lineday,a.startcity,a.overcity,a.shownum,a.satisfyscore,a.bookcount,a.jifentprice,a.jifenbook,a.jifencomment,a.attrid,a.kindlist,a.color,a.iconlist,a.reserved1,a.linetitle,a.linesubtitle,a.bigpic,a.packpic,a.mobilepic";
	...
	else if($type=='top')
	{
		...
		{	
			if(empty($attrid)){
		   	...
		   	$sql="select {$basefield} from #@__line a where {$find} {$w} and  a.ishidden=0  order by a.displayorder asc,a.modtime desc,a.addtime desc limit {$limit},{$row}";
		}
