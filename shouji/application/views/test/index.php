...
<title>{$seotitle}mytest-{$webname}</title>
    <meta name="keywords" content="{$keyword}" />
    <meta name="author" content="{$webname}" />
    <meta name="description" content="{$description}" />
 {php echo Common::getScript('jquery-min.js,idangerous.swiper.js,common.js'); }
...
<body>
  ...
  <div class="main_page clearfix">
    ...
    <div class="search_home clearfix">
       <form method="post" action="{$cmsurl}mdd/search" onsubmit="return check();">
