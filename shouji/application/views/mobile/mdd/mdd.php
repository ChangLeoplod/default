            ...
            <div class="mdd_con">
              ...
              {/if}
                <a href="{$cmsurl}lines/show/id/{$v['id']}">
                  ...
                  <img src="{$v['linepic']}" alt="" width="140" height="100">
              ...
              <p>
                ...
                {/if}
                  <a href="{$cmsurl}cars/show/id/{$v['id']}">
                    <em>{if $v['carprice']==0}电询{else}&yen;{$v['carprice']}{/if}</em>
               ...
               {if $key%2==0}
                ...
                {/if}
                  <a href="{$cmsurl}hotels/show/id/{$v['id']}">
                    <em>{if $v['hotelprice']==0}电询{else}&yen;{$v['hotelprice']}{/if}</em>
                    <img src="{$v['litpic']}" alt="" width="140" height="100">
               ...
               {if $key%2==0}
                ...
                {/if}
                  <a href="{$cmsurl}spot/show/id/{$v['id']}">
                    <em>{if $v['doorprice']==0}电询{else}&yen;{$v['doorprice']}{/if}</em>
                    <img src="{$v['litpic']}" alt="" width="140" height="100">
