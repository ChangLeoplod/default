  ...
  <div class="m-main">
    ...
    <div class="show-jc-js">
      ...
      <ul>
      	<li class="li_1">
        	<p>
          	<span><em>&yen;{$tuan['ourprice']}</em> 起</span>
            <span class="myd"><a href="{$cmsurl}page/pinlun/id/{$tuan['id']}/typeid/13"><b class="fl" style=" width:100%">满意度：<em>{$tuan['score']}</em></b></span>
          </p>
        </li>
      </ul>
