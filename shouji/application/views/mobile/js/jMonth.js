		...
		do {
			...
			for (var i=0; i<7; i++) {
				...
				//{
				 //  var _cdate='';	
				//}
				 var dateLink = jQuery('<div class="DateLabel"><a href="javascript:;">' + _cdate + '</a></div>').click(function(e) {
				...
				{
					$myTd="<td onmouseover=\"this.className='mouseover'\" onmouseout=\"this.className='mouseout'\"></td>";
				}
