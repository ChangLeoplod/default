  ...
  <div class="m-main">
        ...
        {loop $list $v}
            ...
            <a href="{$cmsurl}lines/show/id/{$v['id']}">
              <div class="pdt_img"><img src="{$v['linepic']}" width="90" height="64"></div>
              <div class="pdt_txt">
                <div class="pdt_box">
                  <p class="p_tit">{$v['linename']}...</p>
                  <p class="p_pir">
                  {if $v['lineprice']==0}
                  <strong>电询</strong>
                  {else}
                  ...
                  {/if}
                  <span>满意度{$v['satisfyscore']}</span></p>
                </div>
              </div>
            </a>
          </div>
        ...
        var url='/shouji/lines/list/?kindid='+kindid+'&days='+days+'&attrid='+attrid+'&pricetyle='+pricetyle+'&key='+key+'&action=ajaxline&page='+page+'&order='+order;
         $.get(url,function(results){
            ...
            for(a in results){
                ...
                str += '<div class="pdt_list"><a href="{$cmsurl}lines/show/id/'+results[a]['id']+'"><div class="pdt_img"><img src="'+results[a]['linepic']+'" width="90" height="64"></div><div class="pdt_txt"><div class="pdt_box"><p class="p_tit">'+results[a]['linename']+'...</p><p class="p_pir"><strong>'+temprice+'</strong><span>满意度'+results[a]['satisfyscore']+'</span></p></div></div></a></div>';
                listnum++;
