...
$('.load-more').click(function(){
        ...
        var url='/shouji/raider/list/kindid/'+kindid;
         $.get(url+'/attrid/'+attrid+'/action/ajaxline/page/'+page+'/order/'+order,function(results){
            ...
            var listnum = 0;
            for(a in results){
               str += '<div class="pdt_list"><a href="{$cmsurl}raider/show/id/'+results[a]['id']+'"><div class="pdt_img"><img src="'+results[a]['litpic']+'" width="90" height="64"></div><div class="pdt_txt"><div class="pdt_box"><p class="p_tit"><em>'+results[a]['articlename']+'</em><span>'+results[a]['content']+'...</span></p></div></div></a></div>';
                listnum++;
            }
