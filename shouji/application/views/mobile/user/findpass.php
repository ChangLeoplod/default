...
<div class="container">
    ...
    <div class="main"> 
         <div class="modify-common-passenger p15">
              ...
              <div class="mt10">
                  <input type="submit" id = "reg" class="btn w100 p10 font16 white mt10" value="修改密码" />
...
$(function(){
   $("#reg").click(function(){
        ...
        $.ajax({
            ...
            data:{"mobile":mobile,"password":pwd,"repassword":repassword,"checkcode":checkcode,"backurl":backurl,"f":1},
            dataType:'json',
