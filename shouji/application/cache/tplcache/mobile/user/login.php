...
<div class="container">
    ...
    <div class="main"> 
         <div class="modify-common-passenger sign-in p15">
              <form action="<?php echo $cmsurl;?>user/dologin" method="post" onsubmit="return loginFrm();"> 
            ...
            <input type="hidden" name="forwardurl" value="<?php echo $forwardurl;?>">
              ...
              <div class="mt10">
                  <a href="<?php echo $cmsurl;?>user/register?forwardurl=<?php echo $forwardurl;?>"><button type="button" class="btn font16 p10 white mt10 pull-left bg-green" style="padding:10px 18px;">
                    5秒注册
                      </button></a>
                  <a href="<?php echo $cmsurl;?>user/findpass?forwardurl=<?php echo $forwardurl;?>"><button type="button" class="btn font16 p10 mt10 pull-right bg-grey grey" style="padding:10px 18px;">
                    忘记密码
                      </button></a>
              </div>
              </form>
