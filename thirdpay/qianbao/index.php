...
$getway			= "http:// 1-1.bonusepay.com/payment/getwaychange.html";
$key 			= $GLOBALS['cfg_qianbao_key'];
$merchno 		= "000000000000000";
$dsorderid 		= date("YmdHis");
$amount			= 0.01;
$dsyburl		= "http://www.shangliantong.com/qianbao_demo/dsyburl.php";//异步通知
$dstburl		= "http://www.shangliantong.com/qianbao_demo/dstburl.php";//同步通知
...
?>
<form action="<?php echo  $getway;?>" method="post" >
<input type="hidden" name="merchno" value="<?php echo $merchno;?>"  />
<input type="hidden" name="dsorderid" value="<?php echo $dsorderid;?>"  />
<input type="hidden" name="amount" value="<?php echo $amount;?>"  />
<input type="hidden" name="dsyburl" value="<?php echo $dsyburl;?>"  />
<input type="hidden" name="dstburl" value="<?php echo $dstburl;?>"  />
<input type="hidden" name="productdesc" value="<?php echo $productdesc;?>"  />
<input type="hidden" name="sign" value="<?php echo $sign;?>"  />
<input type="submit" value="提交" />
</form>

<a href="<?php echo $url?>" target="_blank">支付</a>
...

{
	...
	function encrypt($str) {
		...
		$encode= strtoupper( bin2hex( mcrypt_cbc(MCRYPT_DES, $this->key, $str, MCRYPT_ENCRYPT, $this->iv ) ) );
	...
	function decrypt($str) {
		...
		$str=trim(chop(base64_decode($str)));
